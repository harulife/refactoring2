export default class StoreItemRepo {
    public static async count_byGroup(engine: string, params: object){
        try{
            const repo = new StoreItemCountByGroup(params);
            if(engine === 'es')
                repo.beES()
...
class StoreItemCountByGroup{
    ...
    async exec(){
        try{
            ...
            if(this.elasticSearch) {
                this.elasticSearch.checkData();
                this.elasticSearch.makeQuery();
                this.elasticSearch.makeGroupQuery();
            } else {
                this.checkData();
    ...
    beES(){
        this.elasticSearch = new StoreItemCountByGroupByES(this)
    }
}

class StoreItemCountByGroupByES{
    constructor(params) {
